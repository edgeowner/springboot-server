package com.atmatrix.greenland.core.conf;
...
public class Conf {
     ...
     */
    public static final String SSO_SESSIONID = "greenland_sso_sessionid";
     ...
     */
    public static final String SSO_USER = "greenland_sso_user";
