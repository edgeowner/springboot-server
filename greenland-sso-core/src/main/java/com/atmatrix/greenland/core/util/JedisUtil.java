package com.atmatrix.greenland.core.util;
...
public class JedisUtil {
    ...
    private static ShardedJedis getInstance() {
                ...
                if (INSTANCE_INIT_LOCL.tryLock(2, TimeUnit.SECONDS)) {
                    ...
                    try {
                        ...
                        if (shardedJedisPool == null) {
                            ...
                            logger.info(">>>>>>>>>>> greenland-sso, JedisUtil.ShardedJedisPool init success.");
                        }
        ...
        if (shardedJedisPool == null) {
            throw new NullPointerException(">>>>>>>>>>> greenland-sso, JedisUtil.ShardedJedisPool is null.");
        }
    ...
    public static void main(String[] args) {
        String ssoRedisAddress = "redis://xxl-sso:password@127.0.0.1:6379/0";
