package com.atmatrix.greenland.controller.resolver;

import com.atmatrix.greenland.core.exception.GreenlandSSOException;
...
public class WebExceptionResolver implements HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest request,
        ...
        if (ex instanceof GreenlandSSOException) {
